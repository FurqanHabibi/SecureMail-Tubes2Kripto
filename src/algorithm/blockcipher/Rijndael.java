...
public class Rijndael {
	...
	private int         BC = 32;
    private long        BC_MASK = 0xffffffffL;
    private int         ROUNDS = 16;
    private int         blockBits = 128;
    private byte[]      shifts0SC = shifts0[0];
    private byte[]      shifts1SC = shifts1[0];
        ...
        byte[]      key)
    {
        int         KC = 4;
        int         t, rconpointer = 0;
        byte[][]    tk = new byte[4][KC];
        long[][]    W = new long[ROUNDS+1][4];
